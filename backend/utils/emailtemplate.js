              ...
              <tr>
                <td>
                  <div style="background-color:#6c63ff; border-radius:12px; width:56px; height:56px; text-align:center; margin-bottom:24px;">
                    <span style="color:#fff; font-size:20px; font-weight:bold; line-height:56px;">S</span>
                  </div>
                  ...
                  <p style="color:#888; font-size:12px; line-height:1.6; margin:0;">If you didn't sign up for Schedly, you can safely ignore this email.</p>
                </td>
              </tr>
            </table>
          </td>
