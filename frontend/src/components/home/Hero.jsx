...
<div className="absolute left-10 top-20 hidden lg:grid grid-cols-2 gap-6 w-48 opacity-80">
  {/* Row 1 */}
  <div className="animate-float w-15 h-15 blur-sm rounded-2xl bg-gradient-to-br from-red-400 to-red-500 flex items-center justify-center text-3xl shadow-lg transform hover:scale-110 transition-transform duration-300">
    👏
  </div>
  <div className="animate-float w-16 h-16 rounded-xl bg-white flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300">
  ...
  <div className="animate-float w-15 h-15 blur-sm rounded-2xl bg-gradient-to-br from-purple-400 to-purple-500 flex items-center justify-center text-3xl shadow-lg transform hover:scale-110 transition-transform duration-300">
    🚀
  </div>
  {/* Row 3 */}
  <div className="animate-float w-15 h-15 blur-sm rounded-2xl bg-gradient-to-br from-yellow-400 to-yellow-500 flex items-center justify-center text-3xl shadow-lg transform hover:scale-110 transition-transform duration-300">
    ❤️
  </div>
  <div className="animate-float w-16 h-16 rounded-xl bg-white flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300">
    <svg width="32" height="32" viewBox="0 0 24 24">
  ...
  <div className=" animate-float w-15 h-15 blur-sm rounded-2xl bg-gradient-to-br from-teal-400 to-teal-500 flex items-center justify-center text-3xl shadow-lg transform hover:scale-110 transition-transform duration-300">
    📈
  </div>
</div>

{/* Decorative Elements - Right Side */}
<div className="absolute right-10 top-20 hidden lg:grid grid-cols-2 gap-6 w-48 opacity-80">
  {/* Row 1 */}
  <div className="animate-float w-16 h-16 rounded-xl bg-white flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300">
    <svg width="32" height="32" viewBox="0 0 24 24">
  ...
  <div className="animate-float w-15 h-15 blur-sm rounded-2xl bg-gradient-to-br from-green-400 to-green-500 flex items-center justify-center text-3xl shadow-lg transform hover:scale-110 transition-transform duration-300">
    📣
  </div>
  {/* Row 2 */}
  <div className="animate-float w-15 h-15 blur-sm rounded-2xl bg-gradient-to-br from-pink-400 to-pink-500 flex items-center justify-center text-3xl shadow-lg transform hover:scale-110 transition-transform duration-300">
    💬
  </div>
  <div className="animate-float w-16 h-16 rounded-xl bg-white flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300">
    <svg width="32" height="32" viewBox="0 0 24 24">
  ...
  <div className="animate-float w-15 h-15 blur-sm rounded-2xl bg-gradient-to-br from-blue-400 to-blue-500 flex items-center justify-center text-3xl shadow-lg transform hover:scale-110 transition-transform duration-300">
    🗓️
  </div>
  {/* Row 4 */}
  <div className="animate-float w-15 h-15 blur-sm rounded-2xl bg-gradient-to-br from-red-400 to-red-500 flex items-center justify-center text-3xl shadow-lg transform hover:scale-110 transition-transform duration-300">
